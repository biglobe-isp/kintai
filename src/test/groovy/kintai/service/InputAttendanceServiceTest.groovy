...
class InputAttendanceServiceTest extends Specification {
    ...
    def "偽のrepositoryを作成し、勤怠記録へ入れてテストの残業１就業９時間の期待値が帰ってくるかのテスト"() {
        ...
        def input = new InputAttendance(new WorkDay("2023-07-31"),new WorkStart("09:00:00"),new WorkEnd("20:00:00"))
        // 残業１時間　就業9時間の期待値にする。
        def expected = new WorkingDateTotalRecord(new WorkDay("2023-07-31"),new WorkStart("09:00:00"),new WorkEnd("20:00:00"),new OverWorkMinutes(60),new WorkMinutes(540))
